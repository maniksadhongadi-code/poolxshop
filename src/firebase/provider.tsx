...
export const useFirebase = (): FirebaseServicesAndUser | null => {
  ...
  if (context === undefined) {
    // This can happen if the provider is not yet mounted. Return null.
    return null;
  }

  if (!context.areServicesAvailable || !context.firebaseApp || !context.firestore || !context.auth) {
    // This can happen during initial client render before firebase is initialized. Return null.
    return null;
  }
...
export const useUser = (): UserHookResult => {
  ...
  const { user, isUserLoading, userError } = services;
